...
async def handle_start(message: Message):
    ...
    await message.answer(
        f"👋 Привет, {user_name}!\n\n"
        f"Я — мультимодальный бот. Вот что я умею:\n\n"
        f"📝 **Текст и диалог**\n"
        f"• Отвечаю на любые вопросы\n"
        f"• Поддерживаю контекст беседы (помню, о чём говорили)\n"
        f"• Могу менять стиль общения (например, 'говори как хиппи')\n\n"
        f"🖼️ **Генерация изображений**\n"
        f"• Создаю картинки по текстовому описанию\n"
        f"• Генерирую в фоне, чтобы вы не ждали\n"
        f"• Пример: 'нарисуй закат на море'\n\n"
        f"💰 **Курсы валют и криптовалют**\n"
        f"• Текущий курс доллара, евро, рубля и других валют\n"
        f"• Курс биткоина, эфира, USDT\n"
        f"• Примеры: 'курс доллара', 'курс биткоина'\n\n"
        f"🎯 **Отслеживание целей**\n"
        f"• Установите целевой курс и получите уведомление\n"
        f"• Пример: 'следить за биткоином' → введите цель → подтвердите\n"
